...
- 目标用户：18—65 岁、希望在联系人工或线下医疗服务前整理发热、咳嗽、头痛或头晕信息的成人。
...
多主诉会共享起病时间和已采取措施；发热/咳嗽既有共享槽位保持不变。条件槽位只在前置回答成立时出现，例如有痰才询问痰液颜色。腹痛和胸部不适仍未进入普通产品流程。

## 安全边界

Demo 使用保守风险规则识别明确胸痛、明显呼吸困难、意识异常或昏厥，以及头痛/头晕伴明确的突然语言、视力、单侧肢体异常等表达。命中后立即停止普通流程，Provider 调用次数为 0，并显示固定的人工/线下就医提示。规则不是完整临床分诊标准，也不对风险原因作疾病判断。
...
5. `unsupported`：年龄或人群不在演示范围，或规则无法识别四个受支持主诉。
