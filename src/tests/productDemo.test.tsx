...
describe('产品化页面与演示能力', () => {
  ...
  it('生产隐藏条件和Docker敏感文件排除已配置', () => {
    ...
    expect(welcome).toContain('import.meta.env.DEV && <section className="demo-cases"')
    expect(welcome).toContain('import.meta.env.DEV && <fieldset className="dev-controls"')
    expect(app).toContain('import.meta.env.DEV && result')
