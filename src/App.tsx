...
import { answerCurrentSlot, skipCurrentSlot, startSession } from './harness/intakeController'
  ...
  return (
    <div className="app-shell">
      ...
      {result?.session.status === 'collecting' && result.question && (
        <IntakePage session={result.session} question={result.question} onAnswer={answer} onSkip={skip} />
      )}
