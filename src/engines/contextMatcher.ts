...
const RESOLVED_CLAUSE = /(?:烧退了|退烧了|退热了|已经不(?:发烧|发热|咳嗽|胸痛|头痛|头疼|脑袋疼|头晕|发晕|眩晕|腹痛|肚子疼|肚子痛|胃疼|胃痛)|(?:发热|发烧|咳嗽|胸痛|头痛|头疼|脑袋疼|后脑勺疼|太阳穴疼|头晕|发晕|眩晕|天旋地转|站不稳|走路发飘|腹痛|肚子疼|肚子痛|胃疼|胃痛|症状).{0,12}(?:(?:已经|现在|目前)?(?:好了|消失|缓解|恢复)|不疼了|不痛了|不晕了)|(?:现在|已经|目前)(?:完全)?好了|恢复正常(?:体温)?|已经恢复)/u
