...
export function WelcomePage({
  ...
  return (
    <main className="welcome-page">
      ...
      <p className="lead">
        当前支持 18—65 岁成人的发热、咳嗽、头痛、头晕和实验性腹痛信息整理。它不会提供疾病诊断、药物或治疗建议。
      </p>
      ...
      <section className="start-card" aria-label="开始预问诊">
        ...
        <div className="quick-start">
          ...
          <button disabled={!canStart} onClick={() => onStart('abdominal_pain')}>
            腹痛快速入口（实验性）
          </button>
        </div>
        <p className="experimental-notice">腹痛模块为实验性信息整理功能。</p>
        <button
      ...
      <p className="welcome-example"><strong>示例输入：</strong>“昨天开始右下腹疼，一阵一阵的。”</p>
    </main>
  )
}
